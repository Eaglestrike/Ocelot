...
/**
 * An interface used by an Interpolating Tree as the Key type. Given two endpoint keys and a
...
public interface InverseInterpolable<T> {
    /**
     * Given this point (lower), a query point (query), and an upper point (upper), estimate
     * how far (on [0, 1]) between 'lower' and 'upper' the query point lies.
     *
